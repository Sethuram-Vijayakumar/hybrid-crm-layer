...
export default function PipelinePage() {
  ...
  return (
    <div className="space-y-6 font-sans select-none relative">
      ...
      <div className="bg-[#1B1F2A] text-white p-4 rounded-xl flex flex-wrap items-center justify-between gap-4 text-xs font-semibold shadow-xs">
        <div className="flex items-center space-x-2">
          <span className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
          <span>Connected to HubSpot</span>
        </div>
        <div className="flex items-center space-x-6 text-slate-350">
          <span>17 Active Opportunities</span>
          <span>3 Pending Approvals</span>
          <span className="text-[#C9922E] font-bold">2 High Risk Opportunities</span>
          <span className="text-amber-400">Delivery nearing capacity</span>
        </div>
      </div>
